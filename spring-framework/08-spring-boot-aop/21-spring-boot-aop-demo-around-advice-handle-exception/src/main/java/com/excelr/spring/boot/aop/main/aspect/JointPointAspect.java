...
{
    @Around("execution(* com.excelr.spring.boot.aop.main.service.*.getFortune(..))")
    public Object aroundGetFortune(
        ...
        {
            // log the exception
            System.out.println("About Raised Exception: " + exc.getMessage() );
    ...
    @After("execution(* com.excelr.spring.boot.aop.main.daoacc.AccountDAO.findAccounts(..))")
